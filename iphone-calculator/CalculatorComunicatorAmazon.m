...
- (void) fetchingResult:(NSNumber *) firstOperand secondOperand: (NSNumber *) secondOperand operator: (enum Operator) operator {
    [self fetchResultAtURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://ec2-184-72-188-165.compute-1.amazonaws.com:8080/demo-ws-spring-mvc/rest/calc/%.02f/%.02f/%d", [firstOperand doubleValue], [secondOperand doubleValue], operator]]];
}
